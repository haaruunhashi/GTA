...
export const WEAPONS = {
  ar: {
    ...
    vmScale: 0.62,
    hip: [0.170, -0.148, -0.404], hipRot: [0.058, 0.300, 0.140],
    adsDist: 0.130, tracerEvery: 3,
  },
  smg: {
    ...
    vmScale: 0.66,
    hip: [0.164, -0.142, -0.362], hipRot: [0.060, 0.310, 0.142],
    adsDist: 0.135, tracerEvery: 3,
  },
  shotgun: {
    ...
    vmScale: 0.64,
    hip: [0.170, -0.150, -0.386], hipRot: [0.058, 0.296, 0.138],
    adsDist: 0.140, tracerEvery: 1, tracerWidth: 0.014,
  },
  sniper: {
    ...
    vmScale: 0.62,
    hip: [0.172, -0.152, -0.412], hipRot: [0.054, 0.288, 0.132],
    adsDist: 0.130, scope: true, scopeFov: 6.8, tracerEvery: 1, tracerWidth: 0.030,
  },
};
